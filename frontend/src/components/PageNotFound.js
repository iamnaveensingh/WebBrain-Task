...
const PageNotFound = () => {
  return (
    <div className='bg-gray-50 dark:bg-gray-900'>
      <section class="relative min-h-screen z-10 flex items-center justify-center ">
          ...
          <div class="mx-4 flex">
            <div class="w-full px-4">
              <div class="mx-auto max-w-[400px] text-center">
                ...
                <a href="/" class="hover:text-primary inline-block rounded-lg border border-white px-8 py-3 text-center text-base font-semibold text-white transition hover:bg-white">
                  Go To Home
                </a>
              </div>
            </div>
